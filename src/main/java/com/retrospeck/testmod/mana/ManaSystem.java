...
public class ManaSystem {
    ...
    public static void initialize() {
        ...
        if (ticksBetweenRegen > 0) {
            ...
            TestMod.LOGGER.warn("Mana regeneration will be disabled until config value ticksBetweenRegen is reloaded with a positive integer.");
        }
    }
    ...
    public static boolean resetRegenSpeed() {
        try {
            ...
            ticksBetweenRegen = -1;
            TestMod.LOGGER.error("Configuration value ticksBetweenRegen in [mana] is invalid! Expected a positive integer.");
            return false;
        }
        return true;
    }
